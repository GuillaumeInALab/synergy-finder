---
title: "Drug Synergy Analysis for MED"
author: "Marie-Emilie Dourthe & Guillaume P. Andrieu"
date: "10/7/2021"
output:
  pdf_document:
  html_document:
...
## Drug Synergy Analysis - The Thymoglobulin Edition
...
```{r Data Loading}
#drugSynergyData <- read.csv2(file.choose(), header = TRUE)
drugSynergyData <- read.csv(file = "data/dataset.csv", header = TRUE)
...
###########
#ATTENTION : A EXECUTER SEULEMENT SI LA DROGUE 1 A ETE TESTEE EN DOSE UNIQUE
  
   drugComboData <- imputeIntermediateDose(drugComboData)
